...
export const TASAS_MUNICIPALES = {
  ...
  NEUQUEN: {
    ...
    alumbrado: { tasa: 0.002, nombre: "Alumbrado Público", normativa: "Ordenanza municipal" },
    tasa_vial: { tasa: 0.045, nombre: "Tasa Vial (4.5% — la más alta del país)", normativa: "Portal Transparencia Tributaria Municipal, Infobae Mar 2026" },
    total_estimado: 0.06,
    fuente: "Infobae Mar 2026 + Portal Transparencia Tributaria Municipal",
    nota: "Neuquén tiene la tasa vial más alta del país: 4.5% en todos sus municipios.",
  },
  FORMOSA: {
