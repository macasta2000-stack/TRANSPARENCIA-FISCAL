...
// =====================================================
// DATOS AUDITADOS — Fuentes: Infobae Sep 2024, Infobae Nov 2025,
// Infobae Dic 2025 (tasa vial), Portal Transparencia Tributaria Municipal
// =====================================================
const MUNICIPIOS_PBA = {
  Pilar: {
    tish: { tasa: 0.045, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Fiscal Pilar 2025" },
    tish_super: { tasa: 0.065, nombre: "TISH + Ambiental (supermercados)", normativa: "Ord. Fiscal Pilar 2025", nota: "4.5% TISH + 2% tasa ambiental" },
    tasa_vial: { tasa: 0.02, nombre: "Tasa Vial (combustibles)", normativa: "Ord. Fiscal Pilar 2025" },
    fuente: "Infobae Sep 2024 + Ord. Fiscal Pilar",
    auditado: true,
  },
  "La Plata": {
    tish: { tasa: 0.025, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva La Plata 2025" },
    tish_super: { tasa: 0.03, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva La Plata 2025" },
    tasa_vial: null,
    fuente: "Infobae Sep 2024",
    auditado: true,
  },
  "San Isidro": {
    ...
    tasa_vial: null,
    fuente: "Infobae Nov 2025 — San Isidro eliminó tasa vial en 2024",
    auditado: true,
    nota: "San Isidro eliminó la tasa vial en 2024.",
  },
  "Vicente López": {
    ...
    tasa_vial: null,
    fuente: "Infobae Nov 2025 — Vicente López eximió tasa vial en 2025",
    auditado: true,
    nota: "Vicente López eximió la tasa vial en 2025.",
  },
  "Morón": {
  ...
  Quilmes: {
    ...
    tish_super: { tasa: 0.045, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Quilmes 2025" },
    tasa_vial: { tasa: 0.02, nombre: "Tasa Vial (combustibles)", normativa: "Ord. Impositiva Quilmes 2025" },
    fuente: "Infobae Sep 2024 (3.74%) + Infobae Nov 2025 (3.7%)",
    auditado: true,
  },
  Tigre: {
    ...
    fuente: "Infobae Dic 2025 — rango 0.5-2.5%",
    auditado: true,
  },
  Campana: {
  ...
  "Bahía Blanca": {
    tish: { tasa: 0.026, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Bahía Blanca 2025" },
    tish_super: { tasa: 0.085, nombre: "TISH entidades financieras (¡la más alta del país!)", normativa: "Ord. Impositiva Bahía Blanca 2025" },
    tasa_vial: null,
    fuente: "Infobae Sep 2024 (2.6% general) + Portal Transp. Tributaria (8.5% financieras)",
    auditado: true,
    nota: "Bahía Blanca tiene la TISH más alta del país para entidades financieras (8.5%).",
  },
  "Lanús": {
    tish: { tasa: 0.063, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Lanús 2025" },
    tish_super: { tasa: 0.063, nombre: "TISH hipermercados (6%)", normativa: "Ord. Impositiva Lanús 2025" },
    tasa_vial: { tasa: 0.02, nombre: "Tasa Vial (combustibles)", normativa: "Ord. Impositiva Lanús 2025" },
    fuente: "Infobae Sep 2024 (subió de 2.36% a 6%) + Nov 2025 (6.3%)",
    auditado: true,
    nota: "Lanús tiene la TISH general más alta de PBA (6.3%). Subió de 2.36% en 2024.",
  },
  "Lomas de Zamora": {
    tish: { tasa: 0.027, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva LdZ 2025" },
    tish_super: { tasa: 0.035, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva LdZ 2025" },
    tasa_vial: { tasa: 0.02, nombre: "Tasa Vial (combustibles)", normativa: "Ord. Impositiva LdZ 2025" },
    fuente: "Infobae Sep 2024 (subió de 2.25% a 2.70%)",
    auditado: true,
  },
  "Tres de Febrero": {
    tish: { tasa: 0.005, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Tres de Febrero 2025" },
    tish_super: { tasa: 0.008, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Tres de Febrero 2025" },
    tasa_vial: null,
    fuente: "Infobae Nov 2025 — la más baja del conurbano (0.5%)",
    auditado: true,
    nota: "Tres de Febrero tiene la TISH más baja del conurbano (0.5%). No cobra tasa vial. Emprendimientos nuevos están exentos el primer año.",
  },
  "Almirante Brown": {
    ...
    tasa_vial: { tasa: 0.015, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025 — rango 0.5-2.5%" },
    fuente: "Infobae Dic 2025",
    auditado: true,
  },
  "Florencio Varela": {
    ...
    tasa_vial: { tasa: 0.015, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Nov 2025 + Dic 2025",
    auditado: true,
  },
  Berazategui: {
    tish: { tasa: 0.0054, nombre: "TISH base (Seguridad e Higiene)", normativa: "Ord. Impositiva Berazategui 2025" },
    tish_super: { tasa: 0.08, nombre: "TISH diferencial (hasta 8% según rubro)", normativa: "Ord. Impositiva Berazategui 2025" },
    tasa_vial: { tasa: 0.01, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Nov 2025 (0.54% base, hasta 8% según rubro)",
    auditado: true,
    nota: "Berazategui: base 0.54% pero puede llegar a 8% según rubro.",
  },
  Merlo: {
  ...
  Moreno: {
    tish: { tasa: 0.026, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Moreno 2025" },
    tish_super: { tasa: 0.03, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Moreno 2025" },
    tasa_vial: { tasa: 0.015, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Sep 2024 (2.6%) + Dic 2025",
    auditado: true,
  },
  "San Martín": {
    tish: { tasa: 0.015, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Gral. San Martín 2025" },
    tish_super: { tasa: 0.02, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Gral. San Martín 2025" },
    tasa_vial: null,
    fuente: "Infobae Nov 2025 — no tiene tasa vial",
    auditado: true,
  },
  Hurlingham: {
    tish: { tasa: 0.035, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Hurlingham 2025" },
    tish_super: { tasa: 0.045, nombre: "TISH + Tasa Comedores (supermercados)", normativa: "Ord. Impositiva Hurlingham 2025", nota: "3.5% TISH + 1% Tasa de Comedores" },
    tasa_vial: { tasa: 0.015, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Sep 2024 (3.5% + 1% comedores = 4.5%) + Nov 2025",
    auditado: true,
  },
  "Ituzaingó": {
    tish: { tasa: 0.01, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Ituzaingó 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Ituzaingó 2025" },
    tasa_vial: null,
    fuente: "Ord. Impositiva Ituzaingó 2025",
    auditado: false,
  },
  "José C. Paz": {
    tish: { tasa: 0.015, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva José C. Paz 2025" },
    tish_super: { tasa: 0.02, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva José C. Paz 2025" },
    tasa_vial: { tasa: 0.015, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Nov 2025 + Dic 2025",
    auditado: true,
  },
  ...
  "San Miguel": {
    tish: { tasa: 0.012, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva San Miguel 2025" },
    tish_super: { tasa: 0.015, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva San Miguel 2025" },
    tasa_vial: null,
  ...
  "Mar del Plata": {
    tish: { tasa: 0.009, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Gral. Pueyrredón 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Gral. Pueyrredón 2025" },
    tasa_vial: { tasa: 0.03, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025 — 3%, de las más altas" },
    fuente: "Infobae Sep 2024 (0.9% TISH) + Dic 2025 (3% tasa vial)",
    auditado: true,
    nota: "Mar del Plata: TISH baja (0.9%) pero tasa vial alta (3%).",
  },
  "General Pueyrredón": {
    tish: { tasa: 0.009, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Gral. Pueyrredón 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Gral. Pueyrredón 2025" },
    tasa_vial: { tasa: 0.03, nombre: "Tasa Vial (combustibles)", normativa: "Infobae Dic 2025" },
    fuente: "Infobae Sep 2024 + Dic 2025",
    auditado: true,
  },
  Tandil: {
    tish: { tasa: 0.01, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Tandil 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Tandil 2025" },
    tasa_vial: null,
    fuente: "Ord. Impositiva Tandil 2025",
    auditado: false,
  },
  Pergamino: {
    tish: { tasa: 0.01, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Pergamino 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Pergamino 2025" },
    tasa_vial: null,
    fuente: "Ord. Impositiva Pergamino 2025",
    auditado: false,
  },
  "Junín": {
    tish: { tasa: 0.01, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Impositiva Junín 2025" },
    tish_super: { tasa: 0.012, nombre: "TISH diferencial supermercados", normativa: "Ord. Impositiva Junín 2025" },
    tasa_vial: null,
...
export const TASAS_MUNICIPALES = {
  ...
  RIO_NEGRO: {
    ...
    alumbrado: { tasa: 0.002, nombre: "Alumbrado Público", normativa: "Ordenanza municipal" },
    tasa_vial: { tasa: 0.045, nombre: "Tasa Vial (4.5% — Cipolletti, la más alta del país)", normativa: "Portal Transparencia Tributaria Municipal, Infobae Mar 2026" },
    total_estimado: 0.057,
    fuente: "Infobae Mar 2026 — Cipolletti 4.5% tasa vial",
    nota: "Cipolletti (Río Negro) comparte con Neuquén la tasa vial más alta del país: 4.5%.",
  },
  NEUQUEN: {
    tish: { tasa: 0.015, nombre: "TISH (Seguridad e Higiene)", normativa: "Ord. Tarifaria Neuquén 2026" },
    tish_super: { tasa: 0.02, nombre: "TISH supermercados", normativa: "Ord. Tarifaria Neuquén 2026" },
    alumbrado: { tasa: 0.002, nombre: "Alumbrado Público", normativa: "Ordenanza municipal" },
    tasa_vial: { tasa: 0.025, nombre: "Tasa Vial (2.5% real — el 4.5% nominal incluye 2% para estacioneros)", normativa: "LM Neuquén, Diario Río Negro 2025" },
    total_estimado: 0.04,
    fuente: "LM Neuquén + Río Negro + Infobae Mar 2026",
    nota: "La tasa vial nominal es 4.5% pero ~2% va a estacioneros como compensación, no al municipio. El impuesto real al consumidor es ~2.5%. Neuquén eliminó 45 tasas en 2025.",
  },
  FORMOSA: {
